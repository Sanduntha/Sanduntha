...
const sandun = {
  ...
  learning: ["Cloud Architecture", "AI Integration", "Advanced React Patterns", "Cyber Security", "Software Architecture", "Penetration Testing", "Application Security Analyst"],
  workingOn: "HRM systems & ERP system solutions",
